module.exports = {
  ...
  userStatus: "Статус:",
  userRegisteredAt: "Дата регистрации:",
  userJoinedAt: "Дата входа на сервер:",
  userRoles: "Роли:",
  userBot: "Бот?",
  ...
  hackbanSuccess: user => `${user} был успешно хакбанен`,
  hackbanFail: ":x: Не удалось забанить этого пользователя.",
  hackbanUserNotFound: "> :x: Данного ID пользователя не существует.",
  hackbanUserAlreadyInServer: "> :x: Этот пользователь уже есть на сервере, используйте команду `ban` вместо этой.",
  ...
  pollQuestionTooLong: "> :x: Вопрос не должен быть длиннее 256 символов.",
  ...
  wikipediaLinkToPage: "Ссылка на страницу",
  ...
  score: "Баллы:",
  tags: "Теги:",
  postURL: "Ссылка на пост",
  usedBy: tag => `Использовано ${tag}`,
  ...
  invalidMessage: "> :x: Указан неправильный ID сообщения.",
  ...
  pussyDescription: "Получает случайное изображение вагины.\nЭта команда может быть иcпользована только в каналах, помеченных как NSFW.",

  soloDescription: "Получает случайное cоло-изображение.\nЭта команда может быть иcпользована только в каналах, помеченных как NSFW.",

  boobsDescription: "Получает случайное изображение груди.\nЭта команда может быть иcпользована только в каналах, помеченных как NSFW.",
};